program day9p1
  ...
  integer(kind=8) :: boostkeycode,exitopcode

  write(*,'(a)')"Advent of Code 2019 day 9, part 1"
  write(*,'(a)')""
! Initialise intcode array to 0
  ...
  prog(0,0:)=intcode
  pos(0)=0
! Set the input value to 1 (test mode)
  sii(1)=1
  do
...
!   write(*,*)"Exit opcode is ",exitopcode
  ...
  write(*,'(a)')""
  write(*,'(a,i12)')"The BOOST keycode is ",boostkeycode
