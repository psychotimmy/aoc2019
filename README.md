...
**Day 6** A binary tree puzzle. Fun, as I get to play with modules and types for the first time, plus the trim function for strings *and* recursion. This would have been far more difficult in Fortran 77, even if I'd allowed recursion to be used. Part 1 executes in 0.13s. Part 2 to do.
