...
**Day 8** Part 1 is straightforward (count the zeros on each layer and mulitply the number of 1s by number of 2s for the layer with the least 0s). It runs in 0.007s. Part 2 to do.
